...
Popunicorn: Ostres no, el Dr. Xoriço ens ha enganyat, però no us preocupeu, els unicorns us prepararem l'antidot per parar el virus. Vosaltres seguiu buscant les gemes que no queda gaire temps. Seguiu el Mapa! ''',
    ...
    3: {
        "image": "scene2.jpg",
        "text": "Unicorn: oh no! el DR. Xoriço està començant a tapar el sol utilitzant energia que ha robat del nostre món, afanyeu-vos, necessitem les gemmes o aquest malvat es sortirà amb la seva.",
    ...
    4: {
        "image": "scene2.jpg",
        "text": "Unicorns: Moltes gràcies, amb la gemma de l'Est tornem a tenir una mica de màgia per poder-vos ajudar. Amb això podem retressar una estona l'efecte del virus, ara teniu 10 min més per seguir buscant les altres gemmes. Molta sort!",
        "question": "", 
        "answer": "", 
    },
    5: {
        "image": "scene2.jpg",
        "text": '''Unicorns: Com el nostre poder prové de la llum dels arcs de Sant Martí, haureu de recordar la seqüencia de llums en l'ordre correcte. Si ho aconseguiu obtindreu el codi.''',
        "question": "", 
        "answer": "", 
    },
    6: {
        "image": "scene2.jpg",
        "text": '''Unicorns: Moltes gràcies, amb la gemma del Nord tornem a tenir una mica de màgia per poder-vos ajudar. Amb això podem retressar una estona l'efecte del virus, ara teniu 10 min més per seguir buscant les altres gemmes. Molta sort!''',
        "question": "", 
        "answer": "", 
    },
    7: {
        "image": "scene2.jpg",
        "text": '''Unicorns: Moltes gràcies, amb la gemma de l'Oest tornem a tenir una mica de màgia per poder-vos ajudar. Amb això podem retressar una estona l'efecte del virus, ara teniu 10 min més per seguir buscant la última gemma. Molta sort!''',
    ...
    8: {
        "image": "scene2.jpg",
        "text": '''Popunicorn: El Dr. Xoriço va aconseguir estripar un troç del mapa, però no us preocupeu, amb tot el que heu aconseguit ja podeu trobar quin lloc indicava el mapa. No tardeu que encara heu de superar alguna prova per aconguir la Gemma del Sud!''',
    ...
    9: {
        "image": "scene2.jpg",
        "text": '''Unicorns: Moltes gràcies, amb la gemma del Sud ja hem recuperat tot el nostre poder. Ara el DR. Xoriço ja no podrà apagar el sol ni fer més malícies. Ràpid, pugeu tots a l'habitació de l'Alexandra, allà trobareu unes piruletes màgiques amb l'antídot pel virus.''',
        "question": "", 
        "answer": "", 
    }
}
